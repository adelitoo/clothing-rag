...
from ..data_handling.dataloader_utils import create_image_dataloader
from ..data_handling.dataset_utils import ImageDataset
...
class CaptioningPipeline:
    ...
    def _save_results(self, df: pd.DataFrame, captions_dict: dict) -> int:
        ...
        save_path = self.config.COMPLETE_ARTICLES_CSV_PATH 
